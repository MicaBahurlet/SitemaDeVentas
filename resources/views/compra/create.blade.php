                ...
                <div class="p-3 border border-3 border-black ">
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-2">
                            <select name="producto_id" id="producto_id" class="form-control selectpicker show-tick border border-3 border-black" data-live-search="true" title="Busque el producto comprado..." data-size="5">
                        ...
                        <!-- Boton para agregar -->
                        <div class="col-md-4 mb-2">
                            <button id="btn_agregar" type="button" class="btn btn-primary mt-2" style="background-color: #007BA7; font-weight: bold ;color:white">Agregar</button>
                        </div>
                ...
                <div class="p-3 border border-3 border-black">
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-2">
                            ...
                            <select name="proveedore_id" id="proveedore_id" class="form-control selectpicker show-tick border border-3 border-black" data-live-search="true" title="Seleccione un proveedor..." data-size="3">
                        ...
                        <div class="col-md-12 mb-2">
                            <button type="submit" class="btn btn-primary mt-2" id="guardar" style="background-color: #007BA7; font-weight: bold ;color:white">Guardar</button>
