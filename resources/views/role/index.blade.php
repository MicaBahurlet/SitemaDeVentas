        ...
        <div class="mb-4">
            ...
            <div class="collapse" id="collapseExample">
                <div class="card card-body mt-2">
                    <strong>Aquí podrás definir los roles de tu sistema.</strong>
                    ¿Qué es un rol? se trata de los permisos que les daras a el/los usuarios que manejaran la gestión de tu negocio. <br> Una vez creado el rol podrás editarlo o eliminarlo en caso de que ya no lo necesites.
                </div>
            </div>
        </div>
