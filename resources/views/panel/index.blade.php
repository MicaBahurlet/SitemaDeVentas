...
@section('content')
    ...
    <div class="container-fluid px-4">
        ...
        {{-- <div class="card" style="width: 18rem;">
            <img src="{{asset('img/instructions.jpg')}}" class="card-img-top" alt="Logo de StockMaster">
            <div class="card-body">
                <h4 class="card-title">Primeros pasos</h4>
                <p class="card-text">Despejá tus dudas aquí, accede al instructivo <strong>STOCKMASTER</strong></p>
                <a href="{{ route('instrucciones')}}" class="btn btn-create">Ver</a>
            </div>
        </div> --}}
