...
@section('content')
    ...
    <div class="container-fluid px-4">
        ...
        <div class="card" style="width: 18rem;">
            <img src="{{asset('img/compras.jpg')}}" class="card-img-top" alt="...">
            <div class="card-body">
                <h5 class="card-title">Ver mis compras</h5>
                <p class="card-text">Detalle de las últimas compras realizadas </p>
                <a href="#" class="btn btn-create">Ver</a>
            </div>
        </div>
