...
@section('content')
    ...
    <div class="container-fluid px-4">
        ...
        {{-- <div class="alert alert-primary" role="alert">
            <h4 class="alert-heading">¿Qué es una Categoría de Producto?</h4>
            <p>Una categoría de producto agrupa varios productos que comparten características similares. Esto facilita la
                organización y búsqueda de productos específicos.</p>
        </div> --}}
            ...
            <div class="mb-4 ">
                ...
                <div class="collapse" id="collapseExample">
                    <div class="card card-body mt-2">
                        Una categoría de producto agrupa varios productos que comparten características similares. Esto facilita
                        la organización y búsqueda de productos específicos dentro de tu stock.
                    </div>
                </div>
            </div>
        @endcan
